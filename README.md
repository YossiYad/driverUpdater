...
- Optional scheduled scans (Manual / ScanOnly / ScanAndUpdate, daily/weekly/monthly), which can
  ...
  or handed to the AI: the scheduled run reviews every update it found with the configured
  provider and installs only the ones it recommends, up to the risk level you allow.
