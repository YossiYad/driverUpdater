...
public static class ServicesServiceCollectionExtensions
{
    public static IServiceCollection AddDriverUpdaterServices(this IServiceCollection services)
    {
        ...
        ConfigureHpSoftpaqHttpClient(services);
    ...
    private static void ConfigureHpSoftpaqHttpClient(IServiceCollection services)
    {
        services.AddHttpClient(Sources.Internal.Hp.HpSoftpaqRefProvider.HttpClientName, client =>
        {
